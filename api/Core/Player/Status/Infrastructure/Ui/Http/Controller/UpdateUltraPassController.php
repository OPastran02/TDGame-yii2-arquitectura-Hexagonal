...
use api\Core\Player\Status\Application\Command\UpdateUltraPass;
...
class UpdateUltraPassController
{
    private UpdateUltraPass $handler;

    public function __construct()
    { 
        $repository = new StatusRepositoryActiveRecord();
        $this->handler = new UpdateUltraPass($repository);
    }
